...
";
    ...
    private void GuiDonHang()
    {
        ...
        if (Session["GioHang"] != null)
        {
            ...
            #endregion
            // Lấy ngày hiện tại trả về dạng số để làm mã thanh toán trực tuyến
            ...
            DonDatHang.Dondathang_Insert(ngayTao, tongTien.ToString(), mathanhtoantructuyen, maKH, hoTen, soDienThoai, email, "");
