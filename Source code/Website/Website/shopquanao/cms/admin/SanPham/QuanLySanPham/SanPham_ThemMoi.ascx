...
<div class="FormThemMoi">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Phải nhập số" ControlToValidate="tbSoLuong" Display="Dynamic" SetFocusOnError="True" ValidationExpression="(\d)*" ForeColor="Red"></asp:RegularExpressionValidator>
        </div>
    </div>
    <div class="thongTin">
        ...
        <div class="oNhap">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Phải nhập số" ControlToValidate="tbGiaBan" Display="Dynamic" SetFocusOnError="True" ValidationExpression="(\d)*" ForeColor="Red"></asp:RegularExpressionValidator>
        </div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">Ngày tạo</div>
        <div class="oNhap">
            <asp:TextBox ID="tbNngayTao" runat="server"></asp:TextBox>
        </div>
    </div>
        <div class="thongTin">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:CheckBox ID="cbThemNhieuDanhMuc" runat="server" Text="Tạo thêm sản phẩm khác" />
        </div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">&nbsp;</div>
