...
public partial class cms_admin_SanPham_QuanLySanPham_SanPham_HienThi : System.Web.UI.UserControl
{
    ...
    private void LaySanPham()
    {
        ...
        dt = shopquanao.SanPham.Thongtin_Sanpham();
        ...
        <tr id='maDong_" + dt.Rows[i]["MaSP"] + @"'>
               ...
               <td class='cotAnh'>
                 <img class='anhDaiDien'src='/Picture/SanPham/" + dt.Rows[i]["AnhSP"] + @"'/>
                 <img class='anhDaiDienHover'src='/Picture/SanPham/" + dt.Rows[i]["AnhSP"] + @"'/>
               </td>
