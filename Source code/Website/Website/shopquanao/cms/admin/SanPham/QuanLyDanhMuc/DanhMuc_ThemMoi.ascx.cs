...
public partial class cms_admin_SanPham_QuanLyDanhMuc_DanhMucThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if (thaotac == "ChinhSua")
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                ltrAnhDaiDien.Text = "<img class='anhDaiDien'src='/Picture/SanPham/" + dt.Rows[0]["AnhDaiDien"] + @"'/>";
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            shopquanao.DanhMuc.Danhmuc_Insert(tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue, "");
            ltrThongBao.Text = "<div class='thongBaoTaoThanhCong' style='color:#00DD00;font-size:14px;padding-bottom:20px;text-align:center;font-weight:bold'>Đã tạo danh mục: " + tbTenDanhMuc.Text + "</div>";
        ...
        else
        {
            ...
            shopquanao.DanhMuc.Danhmuc_Update(id, tbTenDanhMuc.Text, tenAnhDaiDien, tbThuTu.Text, ddlDanhMucCha.SelectedValue);
