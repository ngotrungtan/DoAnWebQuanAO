...
public partial class cms_admin_TinTuc_DanhMucTin_DanhSachTin_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if (thaotac == "ChinhSua")
        {
            ...
            dt = shopquanao.DanhMucTin.Thongtin_DanhmucTin_by_id(id);
            if (dt.Rows.Count > 0)
            {
                ...
                ltrAnhDaiDien.Text = "<img class='anhDaiDien'src='/Picture/TinTuc/" + dt.Rows[0]["AnhDaiDien"] + @"'/>";
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            if (flAnhDaiDien.FileContent.Length > 0)
            {
                ...
                {
                    flAnhDaiDien.SaveAs(Server.MapPath("Picture/TinTuc/") + flAnhDaiDien.FileName);
                }
            }
            //else ltrThongBao.Text = "Nhập sai hoặc thiếu thông tin! Mời nhập lại";


            shopquanao.DanhMucTin.DanhmucTin_Insert(tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue, "");
        ...
        else
        {
            ...
            shopquanao.DanhMucTin.DanhmucTin_Update(id, tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue);
