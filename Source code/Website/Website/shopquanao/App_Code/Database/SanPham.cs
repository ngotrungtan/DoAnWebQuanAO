...
namespace shopquanao
{
    ...
    public class SanPham
    {
        ...
        public static void Sanpham_Insert(string tensp, string mauID, string sizeID, string chatieuID, string anhsanpham, string soluongsp, string giasp, string motasp, string ngaytao, string ngayhuy, string maDM, string nhomID, string ret)
        {
        ...
        #region Tìm kiếm danh sách sản phẩm theo nhóm Tên SP
        public static DataTable TimKiem_Thongtin_Sanpham_by_TenSP(string TenSP)
        {
            OleDbCommand cmd = new OleDbCommand("timkiem_thongtin_sanpham_by_tensp");
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@TenSP", TenSP);
            return SQLDatabase.GetData(cmd);
        }
