...
namespace shopquanao
{
    ...
    public class DangKy 
    {
        ...
        public static void Dangky_Insert(string tendangnhap,string matkhau,string emaildk,string diachidk,string tendaydu,string cauhoibaomat,string ngaysinh,string gioitinhdk,string maquyen, string ret)
        {
