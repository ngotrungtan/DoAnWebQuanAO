...
namespace shopquanao
{
    ...
    public class KhachHang
    {
        ...
        public static void Khachang_Insert(string tenkh ,string diachikh ,string sdtkh ,string emailkh ,string matkhau, string ret)
        {
            OleDbCommand cmd = new OleDbCommand("khachang_insert");
            cmd.CommandType = CommandType.StoredProcedure;
