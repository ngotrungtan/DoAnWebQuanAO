    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="MenuChinh">
                <div class="container">
                    <ul>
                        <li><a class="<%=("SanPham") %>" href="Admin.aspx?modul=SanPham">Sản phẩm</a></li>
                        <li><a class="<%=("TinTuc") %>" href="Admin.aspx?modul=TinTuc">Tin Tức</a></li>
                        <li><a class="<%=("TaiKhoan") %>" href="Admin.aspx?modul=TaiKhoan">Tài khoản</a></li> 
                        <li><a class="<%=("KhachHang") %>" href="Admin.aspx?modul=KhachHang">Khách Hàng</a></li>
                        <li><a class="<%=("DonDatHang") %>" href="Admin.aspx?modul=DonDatHang">Đơn Hàng</a></li>
                    </ul>
                </div>              
            </div>        
